   ...
   <div id="maskscrol"  class="absolute invisible h-32 w-50 scroll-snap-type-y-mandatory">
               <button>
                 ...
                 <section class=" h-20 w-20 bg-white-100">
                   <span class="inline-block"><img class="h-20 w-20  bg-white mt-4 ml-4 mb-4 mr-4" src="https://firebasestorage.googleapis.com/v0/b/porcelanosa-partners-spaces.appspot.com/o/materials%2F1563187053154%2Fpreview?alt=media&token=d5dcbb60-8267-43d6-94e6-2ab245ce6583" alt="" onClick={() => layeralmond()}/></span>
