...
<div id="maskstaupe" class="container invisible mx-auto relative bg-layer-taupe h-screen max-h-screen bg-cover bg-center bg-no-repeat min-h-screen py-6 flex flex-col justify-center sm:py-12"/>
   ...
   <div id="maskscrol"  class="absolute invisible h-32 w-50 scroll-snap-type-y-mandatory">
               <button>
                 ...
                 <section class="inline-block" onClick={() => layeralmond()}>
                   <span class="inline-block h-24 w-24 bg-white"><img class="h-20 w-20 mt-2 ml-2 mb-2 mr-2" src="https://firebasestorage.googleapis.com/v0/b/porcelanosa-partners-spaces.appspot.com/o/materials%2F1563187053154%2Fpreview?alt=media&token=d5dcbb60-8267-43d6-94e6-2ab245ce6583"/></span>
