...
<div id="maskstaupe" class="container invisible mx-auto relative bg-layer-taupe h-screen max-h-screen bg-cover bg-center bg-no-repeat min-h-screen py-6 flex flex-col justify-center sm:py-12"/>
     ...
     <div id="maskscrol"  class="absolute invisible h-32 scroll-snap-type-y-mandatory w-100 bg-brown-100 rounded-full border-20">
                 <section>
                   <span class="inline-block"><img src="https://firebasestorage.googleapis.com/v0/b/porcelanosa-partners-spaces.appspot.com/o/materials%2F1563187053154%2Fpreview?alt=media&token=d5dcbb60-8267-43d6-94e6-2ab245ce6583" class=" h-14 w-14" alt="" onClick={() => layeralmond()} /></span>
                    <span > Tanzania Almond</span>
                 </section>
                 <section>
                   <span class="inline-block"><img  src="https://firebasestorage.googleapis.com/v0/b/porcelanosa-partners-spaces.appspot.com/o/materials%2F1563187274393%2Fpreview?alt=media&token=1006c9f0-30ee-41e2-979e-0797df79d219" class=" h-14 w-14" alt="" onClick={() => layernatural()}/></span>
                   <span> Tanzania Natural</span>
                 </section>
                 <section>
                   <span class="inline-block"><img src="https://firebasestorage.googleapis.com/v0/b/porcelanosa-partners-spaces.appspot.com/o/materials%2F1563187566938%2Fpreview?alt=media&token=ed0af5cc-aca5-4ae5-84f3-699d6d1710b4" class=" h-14 w-14" alt="" onClick={() => layertaupe()}/></span>
